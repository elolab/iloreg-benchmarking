---
title: "Benchmarking - vanGalen_BM_2"
...
```{r fig_vanGalen_BM_2_ILoReg, fig.height = 10, fig.width = 12, fig.align = "center"}
...
```{r fig_vanGalen_BM_2_Seurat, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r fig_vanGalen_BM_2_SC3, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r fig_vanGalen_BM_2_CIDR, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r fig_vanGalen_BM_2_RaceID3, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r}
save(clustering_iloreg,tsne_iloreg,file="vanGalen_BM_2_ILoReg_clustering_dimensionality_reduction.RData")
save(clustering_Seurat,tsne_Seurat,file="vanGalen_BM_2_Seurat_clustering_dimensionality_reduction.RData")
save(clustering_SC3,tsne_SC3,file="vanGalen_BM_2_SC3_clustering_dimensionality_reduction.RData")
save(clustering_cidr,pca_cidr,file="vanGalen_BM_2_CIDR_clustering_dimensionality_reduction.RData")
save(clustering_raceid3,tsne_raceid3,file="vanGalen_BM_2_RaceID3_clustering_dimensionality_reduction.RData")
