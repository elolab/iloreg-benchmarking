...
data <- data[,sce_object$human==4]
raw_data <- raw_data[,sce_object$human==4]
...
```{r fig_Baron4_ILoReg, fig.height = 10, fig.width = 12, fig.align = "center"}
...
```{r fig_Baron4_Seurat, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r fig_Baron4_SC3, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r fig_Baron4_CIDR, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r fig_Baron4_RaceID3, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r}
save(clustering_iloreg,tsne_iloreg,file="Baron4_ILoReg_clustering_dimensionality_reduction.RData")
save(clustering_Seurat,tsne_Seurat,file="Baron4_Seurat_clustering_dimensionality_reduction.RData")
save(clustering_SC3,tsne_SC3,file="Baron4_SC3_clustering_dimensionality_reduction.RData")
save(clustering_cidr,pca_cidr,file="Baron4_CIDR_clustering_dimensionality_reduction.RData")
save(clustering_raceid3,tsne_raceid3,file="Baron4_RaceID3_clustering_dimensionality_reduction.RData")
