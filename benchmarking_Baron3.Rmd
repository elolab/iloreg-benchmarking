...
data <- data[,sce_object$human==3]
raw_data <- raw_data[,sce_object$human==3]
...
```{r fig_Baron3_ILoReg, fig.height = 10, fig.width = 12, fig.align = "center"}
...
```{r fig_Baron3_Seurat, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r fig_Baron3_SC3, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r fig_Baron3_CIDR, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r fig_Baron3_RaceID3, fig.height = 3, fig.width = 8, fig.align = "center"}
...
```{r}
save(clustering_iloreg,tsne_iloreg,file="Baron3_ILoReg_clustering_dimensionality_reduction.RData")
save(clustering_Seurat,tsne_Seurat,file="Baron3_Seurat_clustering_dimensionality_reduction.RData")
save(clustering_SC3,tsne_SC3,file="Baron3_SC3_clustering_dimensionality_reduction.RData")
save(clustering_cidr,pca_cidr,file="Baron3_CIDR_clustering_dimensionality_reduction.RData")
save(clustering_raceid3,tsne_raceid3,file="Baron3_RaceID3_clustering_dimensionality_reduction.RData")
